...
class SimpleIndexTestCase(unittest.TestCase):
    ...
    def test_simple_index_proxy(self):
    ...
    def test_simple_index_proxy_with_redis(self):
        cases = ["AI算法", "机器学习", "OpenAI", "openai", "AI框架", "项目投资事件", "数据库安全",
                 "小明硕士毕业于中国科学院计算所，后在日本京都大学深造"]

        self.proxy = SimpleIndexProxy.init_index_proxy_from_words(cases, persist_class=RedisIndexPersist())
        print("all index: ", self.proxy.get_all_indexes())
